...
print("（fx, fy, cx, cy）: ", camera.get_intrinsics())
...
depth_data = camera.get_depth()#*1000 # 转换为mm#########################################graspgen需要m单位的深度图
print(depth_data)
...
# 组装成demo_variable需要的intrinsic列表
...
# 2. 构造相机坐标系下的抓取位姿
T_cam_grasp = grasp.pose#get_T(grasp, grasp)          
